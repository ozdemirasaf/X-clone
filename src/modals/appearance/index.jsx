						...
						<div className="bg-[color:var(--background-secondary)] py-2 rounded-2xl flex justify-around items-center	">
							{colors.map((c, index) => (
								<button
									...
									style={{ '--bg': c.primary }}
									className="w-10 h-10 rounded-full bg-[color:var(--bg)] flex justify-center items-center text-white"
								>
									{console.log(color)}
					...
					<section>
						...
						<div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
							<button
								...
								className={classNames("h-16  pr-3 pl-2 bg-white text-[#0f1419] border font-bold border-white/10 rounded flex items-center", {
							...
							<button
								...
								className={classNames("h-16  pr-3 pl-2  bg-[#15202b] text-[#f7f9f9] border font-bold border-white/10 rounded flex items-center", {
							...
							<button
								...
								className={classNames("h-16 pr-3 pl-2 gap-1.5 bg-black text-[#f7f9f9] border font-bold border-white/10 rounded flex items-center", {
