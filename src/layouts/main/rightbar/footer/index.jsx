...
export default function Footer() {
    return (
        <footer className="mb-4 px-4 flex flex-wrap gap-2">
            ...
            <Link to='/' className="text-[#71767b] leading-4 text-[13px] hover:underline">Erişelebilirlik</Link>
            <Link to='/' className="text-[#71767b] leading-4 text-[13px] hover:underline">Rekla Bilgisi</Link>
            <div className="w-full flex gap-2">
                <Popover className='relative inline-flex leading-4 '>
                    <Popover.Button className="text-[#71767b] leading-4 outline-none text-[13px] hover:underline inline-flex items-center">
                        Daha Fazlası
                    ...
                    <Popover.Panel className="w-[150px] max-h-[384px] bg-black shadow-box rounded-xl absolute bottom-0 right-0 grid overflow-hidden">
                        <Link
                            to='/'
