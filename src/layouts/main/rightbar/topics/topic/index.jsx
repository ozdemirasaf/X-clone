    ...
    return (
        ...
        >
            ...
            <Popover className=" absolute top-1.5 right-2">
                ...
                <Popover.Panel className="w-[384px] grid absolute top-2 right-0 rounded-xl bg-black shadow-box z-[1] overflow-hidden">
                    <button type="button" className="py-3 px-4 text-left hover:bg-white/[0.05] transition-colors flex items-center gap-3 text-[15px] leading-5 font-bold text-[#e7e9ea]">
                        <svg viewBox="0 0 24 24" width={18.75}>
                            <path
                                fill="currentColor"
